  ...
  .reduce(
    (acc, key) => ({
      ...
      [key]: root[key].sort((a, b) => {
        const aIsType =
          a.definitionKind === 'type' || a.definitionKind === 'interface'
        const bIsType =
          b.definitionKind === 'type' || b.definitionKind === 'interface'
        ...
        const aIsUpperCase =
          a.definitionName[0].toUpperCase() === a.definitionName[0]
        const bIsUpperCase =
          b.definitionName[0].toUpperCase() === b.definitionName[0]
